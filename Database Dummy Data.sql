...
CALL sp_inventoryItems_Insert (@inventoryItemId, 10, '2018-04-16', 'Widget', '12345-ABC', '16 ounce', 'Discontinued');
CALL sp_inventoryItems_Insert (@inventoryItemId, 10, '2018-04-16', 'Widget', '12345-ABC', '16 ounce', 'Do Not Order');
...
CALL sp_Orders_Insert (@orderId, 'April 2018', 1, 'Created', '2018-03-16', '2018-03-25');
CALL sp_Orders_Insert (@orderId, 'May 2018', 1, 'Shipped', '2018-03-16', '2018-03-25');
CALL sp_Orders_Insert (@orderId, 'June 2018', 1, 'Delivered', '2018-03-16', '2018-03-25');
CALL sp_Orders_Insert (@orderId, 'July 2018', 2, 'Created', '2018-03-16', '2018-03-25');
CALL sp_Orders_Insert (@orderId, 'August 2018', 3, 'Shipped', '2018-03-16', '2018-03-25');
